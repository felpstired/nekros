<section class="cadastro">
    <!-- <div class="cadastrot">
        ...
        <h3>Ao fazer um cadastro, seu progresso no jogo não será perdido!</h3>
    </div> -->
    <div class="cadastrof">
        <div class="ct">
            <img src="./css/img/logo/AA.png" class="cimg" alt="">
            <h2>Cadastro</h2>
        </div>
        ...
        <p>Já tem uma conta? <a href="index.php?page=login">Faça o login!</a></p>
    </div>
</section>